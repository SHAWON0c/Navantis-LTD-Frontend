...
const PrintWarehouseStockinList = ({ purchaseOrders, fromDate, toDate }) => {
  // ================= TOTALS =================
  ...
  const handlePrint = () => {
    ...
    newWindow.document.write(`
      <html>
        <head>
          <title>Warehouse Stockout List - ${today}</title>
          ${styles}
          <style>
...
export default PrintWarehouseStockinList;
