...
//   return (
//     <div id={id} className="grid grid-cols-1 lg:grid-cols-4 gap-6 mt-4 mb-10">
//       {/* ================= FILTERS ================= */}
//       <div className="lg:col-span-2 bg-white p-4 rounded-lg shadow-sm">
//         <h3 className="font-bold mb-4">Filters</h3>
...
//           {/* Today */}
//           <button onClick={handleToday} className="border rounded px-3 py-2">
//             Today
//           </button>
...
//     onClick={() =>
//       onPrint({
//         all: false, // current page only
//       })
//     }
//     className="w-1/2 bg-[#0F213D] text-white py-2 rounded flex items-center justify-center"
//   >
//     <MdPrint className="mr-2" /> Current Page Print
//   </button>
...
//     onClick={() =>
//       onPrint({
//         all: true, // all data, ignore pagination
//       })
//     }
//     className="w-1/2 bg-[#0F213D] text-white py-2 rounded flex items-center justify-center"
//   >
//     <MdPrint className="mr-2" /> All Print
//   </button>
// </div>
//       </div>
//     </div>
...
<div className="flex gap-2">
  {/* Current page print */}
  <button
    onClick={() => onPrint(false)} // pass boolean
    className="w-1/2 bg-[#0F213D] text-white py-2 rounded flex items-center justify-center"
  >
    <MdPrint className="mr-2" /> Current Page Print
  </button>
  ...
  {/* All data print */}
  <button
    onClick={() => onPrint(true)} // pass boolean
    className="w-1/2 bg-[#0F213D] text-white py-2 rounded flex items-center justify-center"
  >
    <MdPrint className="mr-2" /> All Print
  </button>
