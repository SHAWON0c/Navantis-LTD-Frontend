...
//   return (
//     <header className="h-16 w-full flex items-center justify-between px-4 shadow-sm bg- dark:bg-gray-800 dark:text-gray-200">
//       {/* LEFT */}
    ...
    <header className="h-16 w-full flex items-center justify-between px-4 shadow-sm bg-white dark:bg-gray-800 dark:text-gray-200">
      ...
      <div className="flex items-center gap-4 relative">
        ...
        <div className="relative" ref={profileRef}>
          ...
          >
            <img
              src={org?.profilePic || "https://i.pravatar.cc/40"} // ✅ user image
              alt="user"
              className="w-8 h-8 rounded-full border border-gray-300 dark:border-gray-600"
            />
            <div className="hidden lg:block text-sm">
              <div className="font-semibold">{org?.name || user?.email || "User"}</div> {/* ✅ name */}
              <div className="text-xs text-gray-500 dark:text-gray-400">{user?.role || "Role"}</div> {/* ✅ role */}
            </div>
          </div>
          {profileOpen && (
            <div className={dropdownClass}>
